...
object Funcs {
  ...
  def rgb_2_grey: PointOp_3ChannelToPoint[Double, Byte] =
    PointOp_3ChannelToPoint[Double,Byte](_ * 0.2126, _ * 0.7152, _ * 0.0722) ((r,g,b) => (r+g+b).toByte)
  ...
  def rgb2xyz_Combiner: PointOp_3ChannelToPoint[Float, Array[Float]] = {
    PointOp_3ChannelToPoint[Float, Array[Float]](rgb2xyz_Op, rgb2xyz_Op, rgb2xyz_Op)((r,g,b) => {
      val rr = r * 100
      val gg = g * 100
      val bb = b * 100
